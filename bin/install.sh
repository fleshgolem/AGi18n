...
curl https://raw.github.com/fleshgolem/AGi18n/master/bin/genxibstrings > /usr/local/bin/genxibstrings
chmod +x /usr/local/bin/genxibstrings

echo "Downloading agi18n..."
curl https://raw.github.com/fleshgolem/AGi18n/master/bin/agi18n > /usr/local/bin/agi18n
